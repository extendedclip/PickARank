...
import com.extendedclip.pickarank.menu.ClickHandler;
...
public class Settings {
	...
	public void loadConfig() {
		...
		c.options().header("PickARank" + plugin.getDescription().getVersion() + " main configuration file"
				+ "\n"
				...
				+ "\n"
				+ "\nYou must grant the permission node pickarank.close in the click commands or the player will never be able to close the menu!"
				);
